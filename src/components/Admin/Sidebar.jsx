...
const Sidebar = () => {
  ...
  return (
    <div className="w-1/6 bg-blue-600 text-white flex flex-col p-4">
      ...
      <nav>
        <ul>
          ...
          <li
            className={`mb-4 p-2 rounded  cursor-pointer ${
              selectedSection === "Quản lý giao dịch"
                ? "bg-blue-700"
                : "hover:bg-blue-700"
            }`}
          ...
          <li
            className={`mb-4 p-2 cursor-pointer rounded ${
              selectedSection === "Quản lý tài khoản"
                ? "bg-blue-700"
                : "hover:bg-blue-700"
            }`}
