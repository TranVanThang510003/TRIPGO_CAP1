import {
  ...
  useForkRef_default,
  useFormControl
} from "./chunk-GKQIHI7U.js";
import "./chunk-QT63QQJV.js";
import {
  MuiPickersAdapterContext
} from "./chunk-OLLYXNHU.js";
import {
  HTMLElementType,
...
function verifyLicense({
  ...
  const hash3 = licenseKey.substr(0, 32);
  const encoded = licenseKey.substr(32);
  if (hash3 !== md5(encoded)) {
    return {
...
var _excluded = ["children", "className", "slots", "slotProps", "isNextDisabled", "isNextHidden", "onGoToNext", "nextLabel", "isPreviousDisabled", "isPreviousHidden", "onGoToPrevious", "previousLabel", "labelId"];
...
var PickersContext = React12.createContext(null);
...
var useLocalizationContext = () => {
  const localization = React26.useContext(MuiPickersAdapterContext);
  ...
  const localeText = React26.useMemo(() => _extends({}, DEFAULT_LOCALE, localization.localeText), [localization.localeText]);
  return React26.useMemo(() => _extends({}, localization, {
    localeText
...
var _excluded8 = ["value", "referenceDate"];
var singleItemValueManager = {
  ...
  getInitialReferenceValue: (_ref) => {
    let {
      value,
      referenceDate
    } = _ref, params = _objectWithoutPropertiesLoose(_ref, _excluded8);
...
function PickersActionBar(props) {
  ...
  const buttons = actions == null ? void 0 : actions.map((actionType) => {
    switch (actionType) {
      case "clear":
        return (0, import_jsx_runtime21.jsx)(Button_default, {
          onClick: onClear,
  ...
  return (0, import_jsx_runtime21.jsx)(DialogActions_default, _extends({}, other, {
    children: buttons
  }));
}
...
var Chip = React46.forwardRef(function Chip2(inProps, ref) {
  ...
  return (0, import_jsx_runtime26.jsxs)(ChipRoot, {
    as: component,
    className: clsx_default(classes.root, className),
...
function PickersShortcuts(props) {
  ...
  return (0, import_jsx_runtime27.jsx)(List_default, _extends({
    ...
    children: resolvedItems.map((item) => {
      return (0, import_jsx_runtime27.jsx)(ListItem_default, {
        children: (0, import_jsx_runtime27.jsx)(Chip_default, _extends({}, item))
      }, item.id ?? item.label);
    })
  }));
}
...
var usePickerLayout = (props) => {
  ...
  const actionBar = (0, import_jsx_runtime28.jsx)(ActionBar, _extends({}, actionBarProps));
  ...
  const toolbar = toolbarHasView(toolbarProps) && !!Toolbar ? (0, import_jsx_runtime28.jsx)(Toolbar, _extends({}, toolbarProps)) : null;
  const content = children;
  const Tabs = slots == null ? void 0 : slots.tabs;
  const tabs = view && Tabs ? (0, import_jsx_runtime28.jsx)(Tabs, _extends({
    view,
    onViewChange,
  ...
  const shortcuts = view && !!Shortcuts ? (0, import_jsx_runtime28.jsx)(Shortcuts, _extends({}, shortcutsProps)) : null;
  return {
    toolbar,
    content,
    tabs,
...
var PickersLayout = React49.forwardRef(function PickersLayout2(inProps, ref) {
  ...
  return (0, import_jsx_runtime29.jsxs)(PickersLayoutRoot, {
    ref,
    sx,
    className: clsx_default(classes.root, className),
    ownerState: props,
    children: [isLandscape ? shortcuts : toolbar, isLandscape ? toolbar : shortcuts, (0, import_jsx_runtime29.jsx)(PickersLayoutContentWrapper, {
      ...
      children: wrapperVariant === "desktop" ? (0, import_jsx_runtime29.jsxs)(React49.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime29.jsxs)(React49.Fragment, {
...
function DayCalendar(inProps) {
  ...
  return (0, import_jsx_runtime33.jsxs)(PickersCalendarDayRoot, {
    ...
    children: [(0, import_jsx_runtime33.jsxs)(PickersCalendarDayHeader, {
      ...
      }), getWeekdays(utils, now).map((weekday, i2) => (0, import_jsx_runtime33.jsx)(PickersCalendarWeekDayLabel, {
        variant: "caption",
        role: "columnheader",
...
var getReleaseInfo = () => {
  const releaseInfo3 = "MTczMDQzMzYwMDAwMA==";
  if (true) {
...
function calculateRangeChange({
  ...
  if (shouldMergeDateAndTime && selectedDate) {
    if (start2 && rangePosition === "start") {
      selectedDate = mergeDateAndTime(utils, selectedDate, start2);
    }
    if (end2 && rangePosition === "end") {
      selectedDate = mergeDateAndTime(utils, selectedDate, end2);
    }
  }
  if (rangePosition === "start") {
    const truthyResult2 = allowRangeFlip ? {
      nextSelection: "start",
      newRange: [end2, selectedDate]
    } : {
      nextSelection: "end",
      newRange: [selectedDate, null]
    };
    return Boolean(end2) && utils.isAfter(selectedDate, end2) ? truthyResult2 : {
      nextSelection: "end",
      newRange: [selectedDate, end2]
    };
  }
  const truthyResult = allowRangeFlip ? {
    nextSelection: "end",
    newRange: [selectedDate, start2]
  } : {
    nextSelection: "end",
    newRange: [selectedDate, null]
  };
  return Boolean(start2) && utils.isBeforeDay(selectedDate, start2) ? truthyResult : {
    nextSelection: "start",
    newRange: [start2, selectedDate]
  };
}
function calculateRangePreview(options) {
  ...
  const [start2, end2] = options.range;
  const {
    newRange
  ...
  return options.rangePosition === "end" ? [end2, previewEnd] : [previewStart, start2];
}
...
var _excluded14 = ["className", "day", "outsideCurrentMonth", "isEndOfHighlighting", "isEndOfPreviewing", "isHighlighting", "isPreviewing", "isStartOfHighlighting", "isStartOfPreviewing", "selected", "isVisuallySelected", "sx", "draggable", "isFirstVisibleCell", "isLastVisibleCell"];
...
var DateRangePickerDayRaw = React57.forwardRef(function DateRangePickerDay(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDateRangePickerDay"
  });
  ...
  return (0, import_jsx_runtime34.jsx)(DateRangePickerDayRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    sx,
    children: (0, import_jsx_runtime34.jsx)(DateRangePickerDayRangeIntervalPreview, {
      className: classes.rangeIntervalPreview,
      ownerState,
      children: (0, import_jsx_runtime34.jsx)(DateRangePickerDayDay, _extends({}, other, {
        ref,
        disableMargin: true,
        day,
...
true ? DateRangePickerDayRaw.propTypes = {
   ...
   */
  isEndOfHighlighting: import_prop_types19.default.bool.isRequired,
  /**
   * Set to `true` if the `day` is the end of a previewing date range.
   */
  isEndOfPreviewing: import_prop_types19.default.bool.isRequired,
  /**
   * If `true`, day is the first visible cell of the month.
   * Either the first day of the month or the first day of the week depending on `showDaysOutsideCurrentMonth`.
   */
   ...
   */
  isHighlighting: import_prop_types19.default.bool.isRequired,
  /**
   * If `true`, day is the last visible cell of the month.
   * Either the last day of the month or the last day of the week depending on `showDaysOutsideCurrentMonth`.
   */
   ...
   */
  isPreviewing: import_prop_types19.default.bool.isRequired,
  /**
   * Set to `true` if the `day` is the start of a highlighted date range.
   */
  isStartOfHighlighting: import_prop_types19.default.bool.isRequired,
  /**
   * Set to `true` if the `day` is the start of a previewing date range.
   */
  isStartOfPreviewing: import_prop_types19.default.bool.isRequired,
  /**
   * Indicates if the day should be visually selected.
   */
  isVisuallySelected: import_prop_types19.default.bool,
...
var DateRangePickerDay2 = React57.memo(DateRangePickerDayRaw);
...
var useDragRangeEvents = ({
  ...
  const emptyDragImgRef = React58.useRef(null);
  React58.useEffect(() => {
...
var useDragRange = ({
  ...
  const [rangeDragDay, setRangeDragDay] = React58.useState(null);
  const handleRangeDragDayChange = useEventCallback_default((val) => {
    if (!utils.isEqual(val, rangeDragDay)) {
      setRangeDragDay(val);
    }
  });
  const draggingDatePosition = React58.useMemo(() => {
    const [start2, end2] = dateRange;
    if (rangeDragDay) {
      if (start2 && utils.isBefore(rangeDragDay, start2)) {
        return "start";
      }
      if (end2 && utils.isAfter(rangeDragDay, end2)) {
        return "end";
      }
    }
    return null;
  ...
  return React58.useMemo(() => _extends({
    isDragging,
    rangeDragDay,
  ...
  return (0, import_jsx_runtime37.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime37.jsx)(InputAdornmentRoot, {
      ...
      children: typeof children === "string" && !disableTypography ? (0, import_jsx_runtime37.jsx)(Typography_default, {
        color: "textSecondary",
        children
      }) : (0, import_jsx_runtime37.jsxs)(React61.Fragment, {
...
var _excluded17 = ["calendars", "month", "monthIndex", "labelId"];
var _excluded25 = ["format", "slots", "slotProps", "currentMonth", "onMonthChange", "disableFuture", "disablePast", "minDate", "maxDate", "timezone", "reduceAnimations", "views", "view"];
...
var PickersRangeCalendarHeader = React66.forwardRef(function PickersRangeCalendarHeader2(props, ref) {
  const utils = useUtils();
  const translations = usePickersTranslations();
  const {
    calendars,
  ...
  } = other, otherRangeProps = _objectWithoutPropertiesLoose(other, _excluded25);
  ...
  if (calendars === 1) {
    return (0, import_jsx_runtime39.jsx)(PickersCalendarHeader, _extends({}, other, {
      labelId,
      ref
    }));
  }
  ...
  return (0, import_jsx_runtime39.jsx)(PickersRangeCalendarHeaderContentMultipleCalendars, _extends({}, otherRangeProps, {
    ref,
    onGoToPrevious: selectPreviousMonth,
    onGoToNext: selectNextMonth,
...
true ? PickersRangeCalendarHeader.propTypes = {
   ...
   */
  calendars: import_prop_types22.default.oneOf([1, 2, 3]).isRequired,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   */
  month: import_prop_types22.default.object.isRequired,
  /**
   * Index of the month used for this header.
   */
  monthIndex: import_prop_types22.default.number.isRequired,
...
var DateRangeCalendar = React67.forwardRef(function DateRangeCalendar2(inProps, ref) {
  ...
  const valueDayRange = React67.useMemo(() => [value[0] == null || !utils.isValid(value[0]) ? value[0] : utils.startOfDay(value[0]), value[1] == null || !utils.isValid(value[1]) ? value[1] : utils.endOfDay(value[1])], [value, utils]);
  ...
  const draggingRange = React67.useMemo(() => {
  ...
  const wrappedShouldDisableDate = React67.useMemo(() => {
  ...
  const prevValue = React67.useRef(null);
  React67.useEffect(() => {
    var _a, _b;
  ...
  const [rangePreviewDay, setRangePreviewDay] = React67.useState(null);
  const CalendarTransitionProps = React67.useMemo(() => ({
  ...
  const calendarMonths = React67.useMemo(() => Array.from({
    length: calendars
  }).map((_, index) => index), [calendars]);
  const visibleMonths = React67.useMemo(() => {
    if (true) {
  ...
  const focusedMonth = React67.useMemo(() => {
    if (!autoFocus) {
      return null;
    }
    if (value[0] != null) {
  ...
  return (0, import_jsx_runtime40.jsxs)(DateRangeCalendarRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: [(0, import_jsx_runtime40.jsx)(Watermark, {
      packageName: "x-date-pickers-pro",
      releaseInfo: releaseInfo2
    }), calendarMonths.map((monthIndex) => {
      const month = visibleMonths[monthIndex];
      const labelId = `${id}-grid-${monthIndex}-label`;
      return (0, import_jsx_runtime40.jsxs)(DateRangeCalendarMonthContainer, {
        className: classes.monthContainer,
        children: [(0, import_jsx_runtime40.jsx)(CalendarHeader, _extends({}, calendarHeaderProps, {
          month,
          monthIndex,
          labelId
        })), (0, import_jsx_runtime40.jsx)(DayCalendarForRange, _extends({
...
true ? DateRangeCalendar.propTypes = {
   ...
   * @default ['start', 'end']
   */
  availableRangePositions: import_prop_types23.default.arrayOf(import_prop_types23.default.oneOf(["end", "start"]).isRequired),
  /**
   ...
   * Used when the component is not controlled.
   */
  defaultValue: import_prop_types23.default.arrayOf(import_prop_types23.default.object),
  /**
   ...
   */
  focusedView: import_prop_types23.default.oneOf(["day"]),
  /**
   ...
   */
  openTo: import_prop_types23.default.oneOf(["day"]),
  /**
   ...
   */
  value: import_prop_types23.default.arrayOf(import_prop_types23.default.object),
  /**
   * The visible view.
   * Used when the component view is controlled.
   * Must be a valid option from `views` list.
   */
  view: import_prop_types23.default.oneOf(["day"]),
  /**
   * Available views.
   */
  views: import_prop_types23.default.arrayOf(import_prop_types23.default.oneOf(["day"]))
} : void 0;
export {
  DateRangeCalendar,
...
@mui/x-license/index.js:
   ...
   *)
*/
//# sourceMappingURL=@mui_x-date-pickers-pro_DateRangeCalendar.js.map
